...
#
# Fichier      : run_comp_dff_ar_tb.tcl
...
# Version      : 1.0
#
# Utilise      : Compilation et simulation dff_ar.vhd
#
#--| Modifications |--------------------------------------------------------
...
vcom -reportprogress 300 -work work   ../src/dff_ar.vhd

# test-bench compilation
vcom -reportprogress 300 -work work   ../src_tb/dff_ar_tb.vhd
