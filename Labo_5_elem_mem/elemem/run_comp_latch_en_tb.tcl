...
#
# Fichier      : run_comp_latch_en_tb.tcl
...
# Version      : 1.0
#
# Utilise      : Compilation et simulation latch_en.vhd
#
#--| Modifications |--------------------------------------------------------
...
vcom -reportprogress 300 -work work   ../src/latch_en.vhd

# test-bench compilation
vcom -reportprogress 300 -work work   ../src_tb/latch_en_tb.vhd
